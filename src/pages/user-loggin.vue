...
<form class="signup-form"  @submit.prevent="saveUser">
    ...
    <div class="signup-body">
        ...
        <button class="signup-btn" @click="goSign=true" :disabled="isDisabled">Sign up</button>
    </div>
    <button @click="goSign=false" class="new-user-btn">Already have an acount</button>
